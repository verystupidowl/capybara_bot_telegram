...
import static ru.tggc.botapp.util.Text.ATTACK_TEXTS;
import static ru.tggc.botapp.util.Text.DEFEND_TEXTS;
import static ru.tggc.botapp.util.Text.HEAL_TEXTS;
